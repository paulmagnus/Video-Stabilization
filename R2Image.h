...
class R2Image {
 public:
  ...
  // feature detection
  void Features(double sigma, int numFeatures);
  void TranslationMatch(double sigma, int numFeatures, R2Image* other);
  void HomographyMatch(double sigma, int numFeatures, R2Image* other);
